  ...
  return (
    <div className="min-h-dvh bg-surface flex flex-col px-6 py-12 max-w-lg mx-auto">
      ...
      <p className="text-body text-on-surface/60 font-body leading-relaxed mb-8">
        Cuentas, fondos, deudas. Los inmuebles llegan solos desde Finca. Sin gestión: solo el balance.
      </p>
      <ul className="space-y-3 text-label font-body text-on-surface/70 mb-12">
        <li>Anota cada partida en tres campos: qué es, nombre, euros.</li>
        <li>Los datos viven en tu cuenta (Supabase), no solo en el móvil.</li>
        <li>Desde la terminal se puede leer la misma base.</li>
      </ul>
      <button
        type="button"
        onClick={onStart}
