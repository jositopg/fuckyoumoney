...
export function buildWealthBrief(
  ...
  const notesForModel = [
    ...
    'mix.target.profile: landlord (oficio alquiler) o financial. Bandas, no un % mágico: landlord ALQUILER 50–70 y fondos 20–35; financial fondos 60–85 y ladrillo 0–25. Uso propio (casa/solar) no entra en la banda de renta. Colchón = N meses de gasto, no un % del neto.',
    'Ladrillo por encima de banda NO implica vender. Si el efectivo aguanta un parón (≥6–12 meses), el idle a fondos. mix.target.closableNow es lo que se puede cerrar ahora; brickOverEur / fundsShortEur es el hueco hasta la banda. Vender solo si mix.stance=divest_brick; candidatos = vacíos.',
